...
<div class="max-w-4xl mx-auto space-y-6" x-data="{
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="bg-[#FDFBF7] rounded-xl overflow-hidden shadow-xl text-slate-800 text-sm">
        @csrf
        ...
        <div class="p-6 bg-white">
            ...
            <div x-show="tab === 'info'" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="Laptop Lenovo IdeaPad 3" class="w-full p-2.5 rounded-lg bg-white border border-slate-200 text-slate-800 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="hidden" name="sku" value="{{ old('sku', 'SKU-'.time()) }}"> <!-- SKU hidden for now if not in mockup -->
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1.5">
                        ...
                        <!-- En tu mockup decía 2499.00 aquí, pero asumiremos que es Marca -->
                        ...
                        <input type="hidden" name="price" value="{{ old('price', 2499.00) }}"> <!-- Hidden if they used it for price -->
                    </div>
                    <div class="space-y-1.5">
                        <label class="font-medium text-slate-700 text-xs">Precio anterior</label>
                        <input type="number" step="0.01" name="original_price" value="{{ old('original_price') }}" placeholder="2999.00" class="w-full p-2.5 rounded-lg bg-white border border-slate-200 text-slate-800 focus:border-blue-500 outline-none">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                    <div class="space-y-1.5">
                        ...
                        <input type="number" name="stock" required value="{{ old('stock') }}" placeholder="10" class="w-full p-2.5 rounded-lg bg-white border border-slate-200 text-slate-800 focus:border-blue-500 outline-none">
                    </div>
                    <div class="space-y-3 pt-4">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="is_offer" value="1" class="w-4 h-4 rounded text-blue-600 focus:ring-blue-500 border-slate-300">
                            <span class="text-slate-700 font-medium text-sm">Producto en oferta</span>
                        </label>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="is_featured" value="1" checked class="w-4 h-4 rounded text-blue-600 focus:ring-blue-500 border-slate-300">
                            <span class="text-slate-700 font-medium text-sm">Producto destacado</span>
                        </label>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="is_new" value="1" checked class="w-4 h-4 rounded text-blue-600 focus:ring-blue-500 border-slate-300">
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="description" rows="3" required placeholder="Laptop ideal para el trabajo y estudio..." class="w-full p-2.5 rounded-lg bg-white border border-slate-200 text-slate-800 focus:border-blue-500 outline-none resize-none">{{ old('description') }}</textarea>
                </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="url" name="main_image" value="{{ old('main_image') }}" placeholder="URL de imagen" class="w-full text-xs p-1.5 rounded-md border border-slate-200 text-slate-600 outline-none">
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-14 h-14 rounded-lg bg-slate-100 border border-slate-200 flex items-center justify-center overflow-hidden">
                                <span class="text-slate-400 text-[10px]">Img 1</span>
                            </div>
                            <div class="w-14 h-14 rounded-lg bg-slate-100 border border-slate-200 flex items-center justify-center overflow-hidden">
                                <span class="text-slate-400 text-[10px]">Img 2</span>
                            </div>
                            <div class="w-14 h-14 rounded-lg bg-slate-100 border border-slate-200 flex items-center justify-center overflow-hidden">
                                <span class="text-slate-400 text-[10px]">Img 3</span>
                            </div>
